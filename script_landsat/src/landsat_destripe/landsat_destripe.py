"""-----------------------------------------------------------------------------
 ...
 or contained herein.
-----------------------------------------------------------------------------"""
def run_destripe (job_number, tile, columns, rows, windowSize, scallingTop, scallingBottom, iterations, noise, noiseH, noiseL, result_que):
    ...
    result_que.put([job_number, __tile])
